# -*- coding: utf-8 -*-
# Minor modification to https://github.com/pytorch/vision/blob/master/torchvision/models/densenet.py
...
class DenseNet(nn.Module):
    ...
    def save_models(self,epoch,optimizer_dict,save_dir):
        ...
        torch.save(state,save_dir +'/Model' +str(169) + "_{}.model".format(epoch))
